...
import {LandscapeExplainer, LandscapeExplainerProps} from './compositions/LandscapeExplainer';
  ...
  return (
    <>
      ...
      <Composition
        ...
        durationInFrames={900}
        fps={fps}
        width={theme.landscape.width}
        height={theme.landscape.height}
        calculateMetadata={({props}) => {
          const durationSeconds = Number((props as LandscapeExplainerProps).durationSeconds || 30);
          return {
            durationInFrames: Math.max(90, Math.ceil(durationSeconds * fps))
          };
        }}
